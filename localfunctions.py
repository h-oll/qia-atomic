...
"""
functions:
    one_way_function(host,bb84_key, db_id, r, M) : one way function
    T(q) : T rotation  of qubit Q
    invT()q : rotation inverse of qubit q
    CSWAP(q0,q1,q2): controll swap with q0 the controll qubit
    swap_test(conn,q1,q2) : swap test in node conn of 2 qubits register
    qrng() : random 0 or 1
"""
...
if __name__ == "__main__":
    with CQCConnection("Alice") as Alice:
        ...
        swap_test(Alice,qubits1,qubits2)

        #print(q1.measure(), q2.measure(),q3.measure(), q4.measure(),q5.measure(), q6.measure(),q7.measure(), q8.measure(),)


#random toss coin generator
